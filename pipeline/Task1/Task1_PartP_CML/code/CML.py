...
def CML(model_name_tag):
    ...
    clf, test_performance = test_experiment("LGBMClassifier", X_dev, y_dev, X_test, y_test, best_params)

    model_filename = '../results/lgbm_model_'+model_name_tag+'.txt'
    clf.booster_.save_model(model_filename)

    return best_params, test_performance

if __name__ == "__main__":
    best_params, test_performance = CML("CML_test")
